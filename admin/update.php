            ...
            <div id="inputform">
                ...
                <form action="update_execute.php" method="post">
                    <table>
                        <tr height="50">                        
                            <td>ニュースタイトル：</td>
                            <td><input type="text" name="n_title" size="100" value="<?php print $news_title ?>"></td>
                        </tr>
                        <tr height="50">
                            <td>ニュース詳細：</td>
                            <td><textarea name="n_detail" rows="4" cols="100"><?php print $news_detail ?></textarea></td>
                        </tr>
                        <tr height="50">
                            <td>著者名（更新者）：</td>
                            <td><input type="text" name="n_author" size="50" value="<?php print $news_author ?>"></td>
                        </tr>
                        <tr height="50">
                            <td>表示設定</td>
                            <?php 
                                if($news_showfl == 1){
                                    print '<td><input type="radio" name="show_flg" value="1" checked>表示
                                    <input type="radio" name="show_flg" value="0">非表示</td>';
                                }
                                else{
                                    print '<td><input type="radio" name="show_flg" value="1">表示
                                    <input type="radio" name="show_flg" value="0" checked>非表示</td>';
                                }
                            ?>
                            <!--
                    ...
                    <input type="submit" name="s_inputbutton" id="s_inputbutton" value="ニュース内容を更新する">
                </form>
                <form action="news_list.php" method="get">
                    <input type="submit" id="s_inputbutton" value="元に戻る">
                </form>
            </div>
    </body>
</html>